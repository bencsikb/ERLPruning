...
if __name__ == '__main__':
    ...
    parser.add_argument('--hyp', default='data/hyp.scratch.yaml')
    ...
    parser.add_argument('--partial_load', action='store_false')
    ...
    parser.add_argument('--test_case', default="exp_kitti_pruned2")
