...
def create_dataloader(path, label_path, imgsz, batch_size, stride, single_cls, hyp=None, augment=False, cache=False, pad=0.0, rect=False,
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, label_path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
...
def load_image(self, index):
    ...
    if img is None:  # not cached
        ...
        #cv2.imwrite(global_save_path + 'img0.jpg', self.imgs[index])
