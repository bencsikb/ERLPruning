...
class Transformer(nn.Module):
    ...
    def forward(self, src, tgt, tgt_mask=None, src_pad_mask=None, tgt_pad_mask=None):
        ...
        # print(f"self.embedding(src) {(self.embedding(src)).shape}")
        # print(f"self.embedding(src) * math.sqrt(self.dim_model) { (self.embedding(src) * math.sqrt(self.dim_model)).shape}")
