...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained', type=str, default="") #'/root/workdir/ERLPruning/weights/test_97_2534.pth')
    parser.add_argument('--smalldata', type=bool, default=False)
    parser.add_argument('--test-case', type=str, default='fromscratch_coco_2')
